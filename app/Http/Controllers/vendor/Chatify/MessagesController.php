...
class MessagesController extends Controller
{
    ...
    public function pusherAuth(Request $request)
    {
        ...
        $authData = json_encode([
            ...
            'user_info' => [
                'name' => Auth::user()->first_name      // comes from 'users' table?
            ]
        ]);
    ...
    public function index( $id = null)
    {
        ...
        $counsellor = User::where('type', '=', ''.\UserType::USER.'')->where('domain_id','=',Auth::user()->domain_id)->where('id','!=',Auth::user()->id)->get()->toArray();
