...
<section class="">
  <div>
    <a href="{{url("/customer/users/". $domain_id)}}" class="bg-indigo-500 hover:bg-indigo-600 relative shadow-xl rounded-md p-2 mb-12 lg:mb-3 text-gray-100 my-4">
      Back to Users
    </a>
  </div>
    
    <form method="POST" action="{{ url('/customer/user/add') }}" class="mx-auto container max-w-2xl md:w-3/4 shadow-xl">
      @csrf
      <input value="20" name="type" hidden>
      <div class="bg-gray-100 p-4 border-t-2 bg-opacity-5 border-indigo-400 rounded-t">
        <h2 class="font-bold text-2xl my-3">Add User</h2>
        <hr>
