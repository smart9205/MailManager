...
@section('content')
<section class="">
    <a href="{{url("/customer/users/" .$user->domain_id)}}" class="bg-violet-400 hover:bg-violet-500 relative shadow-xl rounded-md p-2 mb-12 lg:mb-3 text-gray-100">
      Back to Users
    </a>
    <form method="POST" action="{{ url('/customer/user/update') }}" class="mx-auto container max-w-2xl md:w-3/4 shadow-xl">
      @csrf               
