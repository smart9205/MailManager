            ...
            <div class="d-flex justify-content-end">
                @if (Auth::user()->type == (UserType::USER))
                    @if(Auth::user()->is_active == 1)
                        <a class="btn-reverse text-center mb-3" 
                            href="{{ url('/chatify')}}">Chat
                            @if ($unreadMsg != 0)
                    ...
                    <div class="card-body">
                        <div class="tab-content p-3  bg-white" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                @if(Auth::user()->is_active == 1)
                                    <p>Welcome to Chatapp, select the "Chat" button <span><i class="ml-2 fa-solid fa-arrow-turn-up"></i></span> to begin your chatting with your preferred user. </p> 
                                @else
                                    <p>You are not allowed to chat, please contact with your customer to allow you chat</p>
                                @endif
                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group {{ $errors->has('old_password') ? 'has-error' : '' }}">
                                                <input type="password" name="old_password" class="form-control form-control" id="old_password"
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group {{ $errors->has('new_password') ? 'has-error' : '' }}">
                                                <input type="password" name="new_password" class="form-control form-control" id="new_password"
                                    ...
                                    <div class="row mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group {{ $errors->has('confirm_password') ? 'has-error' : '' }}">
                                                <input type="password" name="confirm_password" class="form-control form-control" id="confirm_password"
                                                    placeholder="New Password"
                                                    data-parsley-validate-name autocomplete="off" required>
                                            </div>
